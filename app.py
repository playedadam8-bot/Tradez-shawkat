...
# 4. Configuration
API_KEY = "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"
    ...
    with st.spinner("Decoding Market Data..."):
        try:
            ...
            if response.status_code == 200:
                ...
                st.error("⚠️ OpenRouter API Error 402: Insufficient credits. Please top up your account balance on openrouter.ai.")
            else:
