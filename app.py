...
# 2. All API Keys Pool (Cyclic Failover Pool)
API_KEYS = [
...
if st.button("🚀 GENERATE TRADING SIGNAL"):
    with st.spinner(f"AI Analyzing {selected_pair_key} Cycles..."):
        try:
            ...
            # Loop through keys and fallback models if connection drops or times out
            ...
            if success and response and response.status_code == 200:
                ...
                st.error("API Error: All keys and fallback models timed out or failed to connect. Please check your network connection.")
