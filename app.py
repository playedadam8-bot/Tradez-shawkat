...
if st.button("🚀 GENERATE TRADING SIGNAL"):
    with st.spinner(f"AI Analyzing {selected_pair} Cycles..."):
        try:
            ...
            prompt = f"Analyze {selected_pair}. Open: {current_open}, Close: {current_close}. JSON only: {{\"signal\": \"CALL\", \"signal_close_price\": \"...\"}}"
            ...
            if response.status_code == 200:
                ...
                with m2: st.metric("Exp. Close", data.get("signal_close_price"))
