...
st.markdown("""
    ...
    /* Entry Price - Adjusted Smaller Display */
    .entry-container {
...
if st.button("🚀 GENERATE TRADING SIGNAL"):
    with st.spinner(f"AI Analyzing {selected_pair} Cycles..."):
        try:
            ...
            # Determine last candle direction (Bullish/Bearish)
            ...
            # EXACT CURRENT TIME & FUTURE ENTRY TIME (+5 seconds buffer to take trade right before execution)
            ...
            # Detailed prompt forcing OpenAI to output reasoning, last candle analysis, and signals
            prompt = f"""
            ...
            Provide a directional signal ("CALL" or "PUT"), an estimated close price, and a short professional market explanation outlining why this trade setup is valid based on the price action and the last candle behavior.
            ...
            if response.status_code == 200:
                ...
                if "choices" in res_json and len(res_json["choices"]) > 0:
                    ...
                    if json_match:
                        ...
                        # ADJUSTED SMALLER ENTRY PRICE & SYNCHRONIZED TIMINGS
                        st.markdown(f"""
                            <div class="entry-container">
                                ...
                                <div style="color:#00f2fe; font-family:'Rajdhani'; font-size:1.4rem; font-weight:700;">
                                    CURRENT TIME: {formatted_current_time} &nbsp;|&nbsp; TARGET ENTRY TIME: <span style="color:#ffffff;">{formatted_entry_time}</span> (+5s Buffer)
                                </div>
                            </div>
                        """, unsafe_allow_html=True)
