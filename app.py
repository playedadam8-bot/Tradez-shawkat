...
# Flags Mapping formatted strictly as requested (Flag + Pair without slashes)
FLAG_MAP = {
    "EUR/JPY": "🇪🇺🇯🇵 EURJPY", "CAD/JPY": "🇨🇦🇯🇵 CADJPY", "EUR/GBP": "🇪🇺🇬🇧 EURGBP", "AUD/JPY": "🇦🇺🇯🇵 AUDJPY",
    "USD/JPY": "🇺🇸🇯🇵 USDJPY", "AUD/USD": "🇦🇺🇺🇸 AUDUSD", "AUD/CAD": "🇦🇺🇨🇦 AUDCAD", "EUR/USD": "🇪🇺🇺🇸 EURUSD",
    "EUR/CAD": "🇪🇺🇨🇦 EURCAD", "AUD/CHF": "🇦🇺🇨🇭 AUDCHF", "GBP/AUD": "🇬🇧🇦🇺 GBPAUD", "GBP/USD": "🇬🇧🇺🇸 GBPUSD",
    "EUR/AUD": "🇪🇺🇦🇺 EURAUD", "CHF/JPY": "🇨🇭🇯🇵 CHFJPY", "GBP/CAD": "🇬🇧🇨🇦 GBPCAD", "GBP/CHF": "🇬🇧🇨🇭 GBPCHF",
    "GBP/JPY": "🇬🇧🇯🇵 GBPJPY", "USD/CHF": "🇺🇸🇨🇭 USDCHF", "EUR/CHF": "🇪🇺🇨🇭 EURCHF"
}
...
if st.button("🚀 GENERATE TRADING SIGNAL"):
    with st.spinner(f"AI Analyzing {selected_pair_key} Cycles..."):
        try:
            ...
            # Dynamic precise calculation checking exact Open vs Close for accurate color
            ...
            # Exact live 24H system time for exact trade entry timestamp
            ...
            if response.status_code == 200:
                ...
                if "choices" in res_json and len(res_json["choices"]) > 0:
                    ...
                    if json_match:
                        ...
                        # ENTRY CARD: LIVE ENTRY TIME FIRST (24H), THEN PRICE
                        st.markdown(f"""
                        ...
                        # Metrics Display & Custom Clean HTML/CSS Candle Visualizer
