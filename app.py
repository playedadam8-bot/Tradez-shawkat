        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if "choices" in result and len(result["choices"]) > 0:
                    ...
                    # Custom styled button UI mirroring your exact Quotex reference images
                    if signal == "CALL":
                        st.markdown(
                            """
                            <div style="background-color: #28a745; padding: 20px; border-radius: 8px; display: flex; justify-content: space-between; align-items: center; color: white; font-family: sans-serif; margin-top: 15px;">
                        ...
                        st.markdown(
                            """
                            <div style="background-color: #dc3545; padding: 20px; border-radius: 8px; display: flex; justify-content: space-between; align-items: center; color: white; font-family: sans-serif; margin-top: 15px;">
